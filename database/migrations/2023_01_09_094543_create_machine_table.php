...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('machine', function (Blueprint $table) {
            ...
            $table->string('mc_group',50)->nullable()->default('');

            $table->string('mc_name',200)->nullable()->default('');
            $table->string('mc_img',200)->nullable()->default('');
            $table->integer('mc_total')->nullable()->default(0);
