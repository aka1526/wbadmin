                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/{{$datarow->doc_type}}/update" data-parsley-validate
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <input type="date" id="new_date" class="form-control" name="new_date" value="{{$datarow->new_date}}"
                                ...
                                <br />
                                <a href="/{{$datarow->doc_type}}" class="btn btn-secondary"> <i class="fa fa-arrow-left"></i> กลับ </a>
