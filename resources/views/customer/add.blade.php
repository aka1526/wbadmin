        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>ข้อมูล<small>กรุณากรอกข้อมูล</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="/customer/save" data-parsley-validate
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <input type="text" id="customer_name" class="form-control" name="customer_name" value="" placeholder="ชื่อลูกค้า" required />
                                </div>

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="customer_url"> web site :</label>
                                    <input type="text" id="customer_url" class="form-control" name="customer_url" value="" placeholder="http://www.website.com"   />
                                </div>
