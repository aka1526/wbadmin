                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/customer/update"
                                data-parsley-validate enctype="multipart/form-data" method="POST">
                                @csrf
                                <input type="hidden" id="unid" name="unid" value="{{ $datarow->unid }}" />

                                {{-- <div class="col-md-12 col-sm-12 ">
                                    <label for="mc_group">กลุ่มเครื่องจักร *:</label>
                                    <select id="mc_group" name="mc_group" class="form-control" required="">
                                        <option value="">Choose..</option>
                                        @foreach ( $Machinegroup as $group)
                                        <option value="{{ $group->unid}}">{{ $group->group_name}}</option>
                                        @endforeach
                                    </select>
                                </div> --}}
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <input type="text" id="customer_name" class="form-control" name="customer_name" value="{{ $datarow->customer_name }}" placeholder="ชื่อลูกค้า" required />
                                </div>

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="customer_url">web site :</label>
                                    <input type="text" id="customer_url" class="form-control" name="customer_url" value="{{ $datarow->customer_url }}" placeholder="http://www.website.com" required />
                                </div>
                                ...
                                <p>
                                    ...
                                    <input type="radio" class="flat" name="customer_status" id="customer_status_y"
                                        value="Y" checked="" required /> เปิดใช้งาน
                                    <input type="radio" class="flat" name="customer_status" id="customer_status_n"
                                        value="N" /> ปิดใช้งาน
                                </p>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="customer_logo">รูป logo</label>
                                        <input type="file" class="form-control-file" id="customer_logo" name="customer_logo"
                                ...
                                <div class="col-md-12 col-sm-12 my-3">
                                     <img src="http://www.wbadmin.com/upload/customer/{{ $datarow->unid }}/{{ $datarow->customer_logo }}" >

                                </div>

                                <br /><br />
                                <a href="/customer" class="btn btn-secondary"> <i class="fa fa-arrow-left"></i> กลับ </a>
