        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Partners data<small>กรุณากรอกข้อมูล</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="/machine/save" data-parsley-validate
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <input type="text" id="mc_name" class="form-control" name="mc_name" value="" placeholder="ชื่อเครื่องจักร" required />
                                </div>

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="mc_name">จำนวนเครื่องจักร :</label>
                                    <input type="number" id="mc_total" class="form-control" name="mc_total" value="0" min="0" max="200" placeholder="จำนวนเครื่องจักร" required />
                                </div>
