                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/machine/update"
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <select id="mc_group" name="mc_group" class="form-control" required="">
                                        ...
                                        <option value="{{ $group->unid}}" {{ $datarow->mc_group==$group->unid ? ' selected' : '' }}>{{ $group->group_name}}</option>
                                        @endforeach
                                    </select>
                                </div>

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="mc_name">ชื่อเครื่องจักร :</label>
                                    <input type="text" id="mc_name" class="form-control" name="mc_name" value="{{ $datarow->mc_name }}" placeholder="ชื่อเครื่องจักร" required />
                                </div>

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="mc_name">จำนวนเครื่องจักร :</label>
                                    <input type="number" id="mc_total" class="form-control" name="mc_total" value="{{ $datarow->mc_total }}" min="0" max="200" placeholder="จำนวนเครื่องจักร" required />
                                </div>


                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="mc_img">รูป เครื่องจักร</label>
                                        <input type="file" class="form-control-file" id="mc_img" name="mc_img"
                                ...
                                <div class="col-md-12 col-sm-12">
                                    @if($datarow->mc_img)
                                    <img src="{{ "/upload/machine/".$datarow->unid.'/'.$datarow->mc_img }}" width="220px" />
                                    @else
                                ...
                                <br />
                                <a href="/machine" class="btn btn-secondary"> <i class="fa fa-arrow-left"></i> กลับ </a>
