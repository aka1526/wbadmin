        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>รายการเครื่องจักร / Machine List</h2>
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">รุปเครื่องจักร</th>
                                      <th class="column-title">กลุ่มเครื่องจักร</th>
                                      <th class="column-title" >เครื่องเครื่องจักร </th>
                                      <th class="column-title">จำนวน</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class="">
                                            @if($row->mc_img)
                                            <img src="{{ "/upload/machine/".$row->unid.'/'.$row->mc_img }}" width="120px" />
                                            @else
                                        ...
                                        <td class="">{{ $row->mc_name}}</td>
                                        <td class="">{{ $row->mc_total}}</td>

                                        <td class=" last">
                                            <a href="/machine/edit/{{$row->unid}}" class="btn btn-info btn-sm" title="แก้ไข" >แก้ไข </a>
