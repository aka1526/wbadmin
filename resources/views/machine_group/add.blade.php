        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>กลุ่มเครื่องจักร/Machine Group <small>กรุณากรอกข้อมูล</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="/machine/group/save" data-parsley-validate
                                enctype="multipart/form-data" method="POST">
                                @csrf
                                <input type="hidden" id="unid" name="unid" value="" />

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="new_date">ชื่อกลุ่มเครื่องจักร :</label>
                                    <input type="text" id="group_name" class="form-control" name="group_name" value="" placeholder="กลุ่มเครื่องจักร" required />
                                    <br />
                                </div>
