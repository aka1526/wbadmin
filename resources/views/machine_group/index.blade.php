                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title" >ชื่อกลุ่มเครื่องจักร </th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last">
                                            <a href="/machine/group/edit/{{$row->unid}}" class="btn btn-info btn-sm" title="แก้ไข" >แก้ไข </a>
