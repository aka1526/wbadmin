                ...
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="form-post" name="form-post" action="/partners/save" data-parsley-validate
                                ...
                                <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <input type="text" id="partners_name" class="form-control" name="partners_name" value="" placeholder="Partners Name" required />
                                </div>

                                <div class="col-md-12 col-sm-12 ">
                                    <label for="new_date">www:</label>
                                    <input type="text" id="partners_url" class="form-control" name="partners_url" value="" placeholder="www" required />
                                </div>
