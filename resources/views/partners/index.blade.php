                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                  <thead>
                                    <tr class="headings">
                                      ...
                                      <th class="column-title">Loggo</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class="">
                                            @if($row->partners_logo)
                                            <img src="{{ "/upload/partners/".$row->unid.'/'.$row->partners_logo }}" width="120px" />
                                            @else
                                            <img src="/upload/nopic.png"  width="120px"  />
                                            @endif

                                        </td>
                                        <td class=""> {{ $row->partners_name }}</td>
                                        <td class="">{{ $row->partners_url}}</td>


                                        <td class=" last">
                                            <a href="/partners/edit/{{$row->unid}}" class="btn btn-info btn-sm" title="แก้ไข" >แก้ไข </a>
