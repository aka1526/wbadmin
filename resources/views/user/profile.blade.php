        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                  <div class="x_panel">
                        <div class="x_title">
                            <h2>ข้อมูลผู้ใช้ :: {{ $User->fullname}}</h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <!-- start form for validation -->
                            <form id="form-post" name="form-post" action="{{ route('user.updateprofile') }}" data-parsley-validate enctype="multipart/form-data" method="POST">
                               @csrf
                                ...
                                <input type="text" id="fullname" class="form-control" name="fullname"   value="{{ $User->fullname}}" placeholder="ชื่อผู้ใช้งาน"   />
